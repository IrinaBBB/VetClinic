...
namespace DataAccess.Migrations
{
    ...
    [Migration("20230415085143_AddAnimalImageTable")]
    partial class AddAnimalImageTable
    {
            ...
            modelBuilder.Entity("DataAccess.Entities.Animal", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateRegistered = new DateTime(2023, 4, 15, 8, 51, 42, 315, DateTimeKind.Utc).AddTicks(3486),
                            EscapeAttempts = 0,
                            Name = "Lad",
                            Neutered = 0,
                            Sex = 1,
                        ...
                        new
                        {
                            ...
                            Chipped = 1,
                            CreatedBy = "Anna Bergsson",
                            DateOfBirth = new DateTime(2023, 4, 15, 10, 51, 42, 315, DateTimeKind.Local).AddTicks(7164),
                            DateRegistered = new DateTime(2023, 4, 15, 8, 51, 42, 315, DateTimeKind.Utc).AddTicks(7076),
                            EscapeAttempts = 0,
                            Name = "Inka",
                            Neutered = 1,
                            Sex = 2,
                        ...
                        new
                        {
                            ...
                            Chipped = 0,
                            CreatedBy = "Anna Bergsson",
                            DateRegistered = new DateTime(2023, 4, 15, 8, 51, 42, 318, DateTimeKind.Utc).AddTicks(9766),
                            EscapeAttempts = 0,
                            Name = "Dundy",
                            Neutered = 0,
                            Sex = 0,
                        ...
                        new
                        {
                            ...
                            Chipped = 0,
                            CreatedBy = "Anna Bergsson",
                            DateRegistered = new DateTime(2023, 4, 15, 8, 51, 42, 318, DateTimeKind.Utc).AddTicks(9777),
                            EscapeAttempts = 0,
                            Name = "Urshy",
                            Neutered = 0,
                            Sex = 1,
                        ...
                        new
                        {
                            ...
                            Chipped = 2,
                            CreatedBy = "Anna Bergsson",
                            DateOfBirth = new DateTime(2023, 4, 15, 10, 51, 42, 318, DateTimeKind.Local).AddTicks(9781),
                            DateRegistered = new DateTime(2023, 4, 15, 8, 51, 42, 318, DateTimeKind.Utc).AddTicks(9779),
                            EscapeAttempts = 6,
                            Name = "Sebastian",
                            Neutered = 2,
                            Sex = 1,
                        ...
                        new
                        {
                            ...
                            Chipped = 2,
                            CreatedBy = "Anna Bergsson",
                            DateOfBirth = new DateTime(2023, 4, 15, 10, 51, 42, 318, DateTimeKind.Local).AddTicks(9829),
                            DateRegistered = new DateTime(2023, 4, 15, 8, 51, 42, 318, DateTimeKind.Utc).AddTicks(9828),
                            EscapeAttempts = 0,
                            Name = "Jessie",
                            Neutered = 1,
                            Sex = 2,
                        ...
                        new
                        {
                            ...
                            Chipped = 1,
                            CreatedBy = "Anna Bergsson",
                            DateOfBirth = new DateTime(2023, 4, 15, 10, 51, 42, 318, DateTimeKind.Local).AddTicks(9837),
                            DateRegistered = new DateTime(2023, 4, 15, 8, 51, 42, 318, DateTimeKind.Utc).AddTicks(9836),
                            EscapeAttempts = 3,
                            Name = "Quiffy",
                            Neutered = 1,
                            Sex = 2,
                        ...
                        new
                        {
                            ...
                            Chipped = 2,
                            CreatedBy = "Anna Bergsson",
                            DateRegistered = new DateTime(2023, 4, 15, 8, 51, 42, 318, DateTimeKind.Utc).AddTicks(9842),
                            EscapeAttempts = 0,
                            Name = "Woffy",
                            Neutered = 1,
                            Sex = 1,
